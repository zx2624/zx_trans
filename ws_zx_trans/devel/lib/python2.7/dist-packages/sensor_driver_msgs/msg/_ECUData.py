...
class ECUData(genpy.Message):
  _md5sum = "0aea8dada7af9f1ea02824320b82f004"
...
string frame_id
"""
  __slots__ = ['header','fDeForwardVel','fFLRWheelAverAngle','fForwardVel','petral_pressure','pressure_back','FrontLeftWheelSpeed','FrontRightWheelSpeed','BackLeftWheelSpeed','BackRightWheelSpeed']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,fDeForwardVel,fFLRWheelAverAngle,fForwardVel,petral_pressure,pressure_back,FrontLeftWheelSpeed,FrontRightWheelSpeed,BackLeftWheelSpeed,BackRightWheelSpeed
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_9d().pack(_x.fDeForwardVel, _x.fFLRWheelAverAngle, _x.fForwardVel, _x.petral_pressure, _x.pressure_back, _x.FrontLeftWheelSpeed, _x.FrontRightWheelSpeed, _x.BackLeftWheelSpeed, _x.BackRightWheelSpeed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.fDeForwardVel, _x.fFLRWheelAverAngle, _x.fForwardVel, _x.petral_pressure, _x.pressure_back, _x.FrontLeftWheelSpeed, _x.FrontRightWheelSpeed, _x.BackLeftWheelSpeed, _x.BackRightWheelSpeed,) = _get_struct_9d().unpack(str[start:end])
      return self
