...
set(MSG_I_FLAGS "-Ispeed_ctrl_msgs:/home/zx/test/ws_zx_trans/src/msgs/speed_ctrl_msgs/msg")
...
get_filename_component(_filename "/home/zx/test/ws_zx_trans/src/msgs/speed_ctrl_msgs/msg/speed_ctrl.msg" NAME_WE)
add_custom_target(_speed_ctrl_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "speed_ctrl_msgs" "/home/zx/test/ws_zx_trans/src/msgs/speed_ctrl_msgs/msg/speed_ctrl.msg" ""
)
...
_generate_msg_cpp(speed_ctrl_msgs
  "/home/zx/test/ws_zx_trans/src/msgs/speed_ctrl_msgs/msg/speed_ctrl.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/speed_ctrl_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/speed_ctrl_msgs\")")
  # install generated code
  install(
