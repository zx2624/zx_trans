...
set(MSG_I_FLAGS "-Iuuid_msgs:/home/zx/test/ws_zx_trans/src/msgs/uuid_msgs/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/zx/test/ws_zx_trans/src/msgs/uuid_msgs/msg/UniqueID.msg" NAME_WE)
add_custom_target(_uuid_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "uuid_msgs" "/home/zx/test/ws_zx_trans/src/msgs/uuid_msgs/msg/UniqueID.msg" ""
)
...
_generate_msg_cpp(uuid_msgs
  "/home/zx/test/ws_zx_trans/src/msgs/uuid_msgs/msg/UniqueID.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/uuid_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/uuid_msgs\")")
  # install generated code
  install(
